<cfif CGI.REQUEST_METHOD NEQ "POST"
    ...
    <cflocation url="/dir/admin/secrets/create.cfm" addtoken="false">
</cfif>
...
<div class='mt-3'>
    ...
    <pre class='bg-dark text-light p-3 rounded'><code>GET /dir/api/v1/people?secret=#EncodeForHTML(result.rawSecret)#&amp;token=uhcs_...</code></pre>
...
<div class='mt-4'>
    <a href='/dir/admin/secrets/index.cfm' class='btn btn-primary'>Back to Secrets</a>
</div>
">
