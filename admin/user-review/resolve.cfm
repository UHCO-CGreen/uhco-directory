...
<cfif adminUserID LTE 0>
    <cflocation url="/admin/user-review/review.cfm?submissionID=#val(form.submissionID)#&error=#urlEncodedFormat('Your admin session could not be mapped to an AdminUsers record. Please sign out and sign back in.')#" addtoken="false">
    <cfabort>
</cfif>
...
<cfif result.success>
    <cflocation url="/admin/user-review/review.cfm?submissionID=#val(result.submissionID ?: form.submissionID)#&msg=#urlEncodedFormat(result.message)#" addtoken="false">
<cfelse>
    <cflocation url="/admin/user-review/review.cfm?submissionID=#val(form.submissionID)#&error=#urlEncodedFormat(result.message)#" addtoken="false">
</cfif>