...
<div class="d-flex justify-content-between align-items-start flex-wrap gap-3 mb-4">
    ...
    <a href="upload.cfm?template=#urlEncodedFormat(tpl.key)#" class="btn btn-ui-go">
            ...
            <div class="card-body">
                ...
                <form method="post">
                    ...
                    <div class="d-flex gap-2 mt-4">
                        ...
                        <a href="upload.cfm?template=#urlEncodedFormat(tpl.key)#" class="btn btn-ui-go">Upload Existing File</a>
