...
<cfif NOT request.hasPermission("import.manage")>
...
<cfif len(runError)>
    ...
    <a href="index.cfm" class="btn btn-ui-cancel">Back to Import</a>
</cfif>
...
<cfif NOT structIsEmpty(runSummary)>
    ...
    <cfif arrayLen(runDetails)>
        ...
        <div class="d-flex align-items-center gap-2 mb-3">
            ...
            <div class="ms-auto btn-group btn-group-sm" role="group">
                <button type="button" class="btn btn-ui-filter active filter-btn" data-filter="all">All</button>
                <cfif runSummary.SUCCESS_COUNT GT 0>
                    <button type="button" class="btn btn-ui-filter filter-btn" data-filter="success">
                        <i class="bi bi-check"></i> Success (#runSummary.SUCCESS_COUNT#)
                    </button>
                </cfif>
                <cfif runSummary.SKIP_COUNT GT 0>
                    <button type="button" class="btn btn-ui-filter filter-btn" data-filter="skipped">
                        <i class="bi bi-dash"></i> Skipped (#runSummary.SKIP_COUNT#)
                    </button>
                </cfif>
                <cfif runSummary.ERROR_COUNT GT 0>
                    <button type="button" class="btn btn-ui-filter filter-btn" data-filter="error">
    ...
    <div class="d-flex gap-2 mt-4">
        ...
        <cfif NOT structIsEmpty(runSummary)>
            <a href="upload.cfm?template=#runSummary.TEMPLATE_KEY#" class="btn btn-ui-add">
