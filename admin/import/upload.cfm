    ...
    <div class="card shadow-sm mb-4 admin-card-max-600 settings-shell settings-summary-card">
        <div class="card-body">
            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <a href="index.cfm" class="btn btn-ui-cancel ms-2">Cancel</a>
            </form>
        </div>
    </div>
</cfif>
    ...
    <div class="d-flex gap-2">
        <cfif validation.valid>
            <form method="post" action="process.cfm">
                ...
                <button type="submit" class="btn btn-ui-save btn-lg"
                        data-confirm="Import #parsedData.rawRowCount# rows using the #encodeForHTMLAttribute(tpl.label)# template? This cannot be undone.">
                    <i class="bi bi-play-fill me-1"></i>Run Import (#parsedData.rawRowCount# rows)
                </button>
            </form>
        </cfif>
        <a href="upload.cfm?template=#tpl.key#" class="btn btn-ui-cancel btn-lg">
            <i class="bi bi-arrow-counterclockwise me-1"></i>Re-upload
        </a>
        <a href="index.cfm" class="btn btn-ui-cancel btn-lg">Cancel</a>
    </div>
