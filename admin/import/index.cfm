            ...
            <a href="upload.cfm?template=#tpl.key#" class="text-decoration-none">
                <div class="card h-100 shadow-sm settings-hub-card settings-hub-card--primary">
                    <div class="card-body">
                        ...
                        <div class="mt-2">
                            <a href="templates/#tpl.key#_template.csv" download class="small text-primary" data-stop-propagation>
                    ...
                    <tr>
                        ...
                        <td>
                            <cfswitch expression="#run.TEMPLATE_KEY#">
                                ...
                                <cfcase value="bulk_external_ids"><span class="badge settings-badge-primary-soft">External IDs</span></cfcase>
                        ...
                        <td>
                            <a href="process.cfm?run_id=#run.RUN_ID#" class="btn btn-sm btn-ui-go" title="View details">
                                <i class="bi bi-eye"></i>
                            </a>
                        </td>
                    </tr>
