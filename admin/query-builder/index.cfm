<!---
    ...
    Permission: query_builder.use. Tables and columns validated against INFORMATION_SCHEMA.
--->

<cfif NOT request.hasPermission("query_builder.use")>
...
<div class="card shadow-sm mb-4 settings-shell settings-builder-shell">
    ...
    <div class="card-body">
        ...
        <div class="mb-3 admin-hidden" id="columnsSection">
            ...
            <div class="mb-2">
                <button type="button" class="btn btn-sm btn-ui-filter" id="btnSelectAll"><i class="bi bi-check2-square me-1"></i>Select All</button>
                <button type="button" class="btn btn-sm btn-ui-clear" id="btnSelectNone"><i class="bi bi-square me-1"></i>Select None</button>
            </div>
        ...
        <div class="d-flex gap-2 admin-hidden" id="executeSection">
            <button type="button" class="btn btn-ui-filter" id="btnExecute">
                <i class="bi bi-play-fill me-1"></i> Execute Query
            </button>
            <button type="button" class="btn btn-ui-go admin-hidden" id="btnExportCsv">
...
(function () {
    ...
    function addConditionRow() {
        ...
        row.innerHTML =
            ...
            '<div class="col-md-2"><button type="button" class="btn btn-sm btn-ui-delete users-list-action-button users-list-action-button-delete cond-remove" title="Remove Condition" aria-label="Remove Condition"><i class="bi bi-x"></i></button></div>';
    ...
    function addOrderRow() {
        ...
        row.innerHTML =
            ...
            '<div class="col-md-2"><button type="button" class="btn btn-sm btn-ui-delete users-list-action-button users-list-action-button-delete order-remove" title="Remove Order By" aria-label="Remove Order By"><i class="bi bi-x"></i></button></div>';
