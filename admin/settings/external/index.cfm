...
<nav aria-label='breadcrumb'>
    <ol class='breadcrumb'>
        ...
        <li class='breadcrumb-item active'>Manage External IDs</li>
    </ol>
</nav>
            ...
            <tr>
                ...
                <td>
                    <div class='d-flex flex-wrap gap-1 align-items-start users-list-actions external-actions'>
                        <a href='/admin/settings/external/edit.cfm?systemID=#s.SYSTEMID#' class='btn btn-sm btn-ui-edit users-list-action-button users-list-action-button-edit' title='Edit External System' data-bs-toggle='tooltip' data-bs-title='Edit External System' aria-label='Edit External System'><i class='bi bi-pencil-square'></i></a>
                        <a href='/admin/settings/external/delete.cfm?systemID=#s.SYSTEMID#' class='btn btn-sm btn-ui-delete users-list-action-button users-list-action-button-delete' title='Delete External System' data-bs-toggle='tooltip' data-bs-title='Delete External System' aria-label='Delete External System'><i class='bi bi-trash'></i></a>
                    </div>
                </td>
            </tr>
        ">
