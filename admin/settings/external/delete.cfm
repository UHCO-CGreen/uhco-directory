<cfif !structKeyExists(url, "systemID") OR !isNumeric(url.systemID)>
    <cflocation url="#request.webRoot#/admin/settings/external/index.cfm" addtoken="false">
</cfif>
...
<form method='post' action='confirmDelete.cfm' class='admin-inline-form'>
    ...
    <button type='submit' class='btn btn-ui-delete'>Delete System</button>
</form>
<a href='/admin/settings/external/index.cfm' class='btn btn-ui-cancel ms-2'>Cancel</a>
</div>
</div>
" />
