<cfif !structKeyExists(url, "orgID") OR !isNumeric(url.orgID)>
    <cflocation url="#request.webRoot#/admin/settings/orgs/index.cfm" addtoken="false">
</cfif>
...
<cfset content &= "
    ...
    <button type='submit' class='btn btn-ui-save'>Update Organizational Unit</button>
    <a href='/admin/settings/orgs/index.cfm' class='btn btn-ui-cancel ms-2'>Cancel</a>
</form>
