    ...
    <cfif rollbackRunID GT 0>
        ...
        <cftry>
            ...
            <cfif result.success>
                ...
                <cflocation url="#request.webRoot#/admin/migrations/grad_migration.cfm?msg=rollback&runID=#rollbackRunID#&rolled=#rolledCount#&errors=#errCount#" addtoken="false">
            <cfelse>
                <cflocation url="#request.webRoot#/admin/migrations/grad_migration.cfm?msg=error&err=#urlEncodedFormat(result.message)#" addtoken="false">
            </cfif>
        <cfcatch type="any">
            <cflocation url="#request.webRoot#/admin/migrations/grad_migration.cfm?msg=error&err=#urlEncodedFormat(cfcatch.message)#" addtoken="false">
        </cfcatch>
        </cftry>
    </cfif>
...
<cftry>
    ...
    <cflocation url="#request.webRoot#/admin/migrations/grad_migration.cfm?msg=settings" addtoken="false">
<cfcatch type="any">
    <cflocation url="#request.webRoot#/admin/migrations/grad_migration.cfm?msg=error&err=#urlEncodedFormat(cfcatch.message)#" addtoken="false">
</cfcatch>
</cftry>
